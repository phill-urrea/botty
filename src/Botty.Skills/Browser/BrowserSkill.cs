...
/// <summary>
/// Skill for browser automation using Playwright. Provides a snapshot→act loop:
/// see the page as an accessibility tree, then interact with elements by ref.
/// </summary>
public class BrowserSkill : BaseSkill
{
    private readonly BrowserSession _session;

    public BrowserSkill(BrowserSession session, ILogger<BrowserSkill> logger)
        : base(logger)
    {
        _session = session;
    }
    ...
    public override IEnumerable<LlmTool> GetTools()
    {
        ...
        [
            ...
            new LlmTool
            {
                ...
                Description = "Execute JavaScript in the browser and return the result. Must be enabled in skill config.",
                ParametersSchema = """
                {
                    "type": "object",
                    "properties": {
        ...
        switch (context.ToolName)
        {
            case "browser_navigate":
            {
                ...
                if (args == null || string.IsNullOrWhiteSpace(args.Url))
                    return SkillResult.Fail("Missing required argument: 'url'");
            ...
            case "browser_click":
            {
                ...
                if (args == null || string.IsNullOrWhiteSpace(args.Ref))
                    return SkillResult.Fail("Missing required argument: 'ref'");
            ...
            case "browser_type":
            {
                ...
                if (args == null || string.IsNullOrWhiteSpace(args.Ref))
                    return SkillResult.Fail("Missing required argument: 'ref'");
                if (args.Text == null)
                    return SkillResult.Fail("Missing required argument: 'text'");
            ...
            case "browser_evaluate":
            {
                ...
                if (args == null || string.IsNullOrWhiteSpace(args.Expression))
                    return SkillResult.Fail("Missing required argument: 'expression'");
