...
/// <summary>
/// Read-only Interactive Brokers portfolio tool using Client Portal Gateway.
/// </summary>
public class InteractiveBrokersTool : BaseTool
{
    ...
    public InteractiveBrokersTool(
        IbClient ibClient,
        ILogger<InteractiveBrokersTool> logger)
        : base(logger)
    {
        _ibClient = ibClient;
    }
    ...
    private async Task<ToolResult> ListAccountsAsync(IbClientOptions options, CancellationToken ct)
    {
    ...
    private async Task<ToolResult> GetPortfolioSummaryAsync(
        string arguments,
        ...
        CancellationToken ct)
    {
        ...
        if (accountId == null)
        {
            return ToolResult.Fail("No Interactive Brokers account found in the active session.");
        }
    ...
    private async Task<ToolResult> ListPositionsAsync(
        string arguments,
        IbClientOptions options,
        CancellationToken ct)
    {
    ...
    private async Task<ToolResult> GetBalancesAsync(
        string arguments,
        IbClientOptions options,
        CancellationToken ct)
    {
    ...
    private async Task<ToolResult> GetUnrealizedPnlAsync(
        string arguments,
        IbClientOptions options,
        CancellationToken ct)
    {
