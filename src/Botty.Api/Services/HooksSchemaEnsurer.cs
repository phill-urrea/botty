...
/// <summary>
/// Ensures hooks and hook_executions tables exist (for existing DBs that skipped init scripts).
/// </summary>
public static class HooksSchemaEnsurer
{
    private const string EnsureHooksSql = @"
...
";
    ...
    {
        await db.Database.ExecuteSqlRawAsync(EnsureHooksSql, ct);
    }
}
